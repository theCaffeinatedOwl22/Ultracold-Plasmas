function [s] = fieldForTwoCoilExpConfig(zRange,pRange,numZPts,numPPts,amps)
%% Parameters
...
% This program calculates the magnetic field produced by a two-coil system that is equivalent to our
...
zPos = [55 -55];    % in mm
radii = [30 30];   % in mm
pol = [-1 1]; % assign current direction. Left set of loops has one current, right set of loops has the opposite
